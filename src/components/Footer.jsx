                ...
                <div className="footer_wrapper__desktop">
                    <div className="list">
                        <div>
                            ...
                            <ul className="undefined__ul">
                                ...
                                <li className="undefined__ul__li list-item">
                                    <a href="/collection/performance/135">
                                        Performance
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item">
                                    <a href="/collection/daily-wellbeing/73">
                                        Daily Wellbeing
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item">
                                    <a href="/collection/hair/76">
                                        Hair
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item">
                    ...
                    <div className="list">
                        <div>
                            ...
                            <ul className="undefined__ul">
                                <li className="undefined__ul__li list-item"> <a href="https://plixlife.com/blog/">Blog</a> </li>
                                <li className="undefined__ul__li list-item">
                                ...
                                <li className="undefined__ul__li list-item">
                                    <a href="/page/terms-and-conditions-cashaback">
                                        Cashback
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item">
                                    <a href="/page/clean-label-certified">
                                        Clean Label Project
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item">
                                    <a href="/page/pledge-a-tree">
                                        Pledge A Tree
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item">
                                    <a href="/page/patch-test">
                                        Patch Test Guide
                                    </a>
                                </li>
                                <li className="undefined__ul__li list-item"> <a href="https://www.plixlife.com/page/membership">Loyalty Club Membership</a> </li>
                                <li className="undefined__ul__li list-item">
                                    <a href="/page/press">
                                        Press
                                    </a>
                        ...
                        <div>
                            ...
                            <ul className="undefined__ul">
                                ...
                                <li className="undefined__ul__li list-item"> <a href="https://www.plixlife.com/page/track-your-order">Track your order</a> </li>
                            </ul>
                        </div>
                    </div>
                    <div className="list">
                            ...
                            <ul className="footerIcon__ul">
                                <li className="footerIcon__ul__li list-item">
                                    ...
                                    <svg width="1em" height="1em" viewBox="0 0 13 13" fill="none">
                                        <path d="M5.96.103l-.546.52c-.137.136-.137.355 0 .464l4.238 4.238H.328A.332.332 0 000 5.653v.766c0 .191.137.328.328.328h9.324l-4.238 4.266c-.137.11-.137.328 0 .464l.547.52c.11.137.328.137.465 0l5.715-5.715a.315.315 0 000-.465L6.426.103c-.137-.137-.356-.137-.465 0z" fill="#E7E7E7"></path>
                                    </svg>
                                </li>
                            </ul>
                        </div>
            ...
            <div className="container contactUsIcons">
                <div className="logo_social_block">
                    ...
                    <div className="social_link_section">
                        ...
                        <div className="lazyload-wrapper ">
                            <div>
                                <a className="social-icons" target="_blank" rel="noreferrer" href="https://www.instagram.com/myplixlife/">
                                    <span>
                                        <span>
                                            <img alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2730%27%20height=%2730%27/%3e" />
                                        </span>
                                        <img alt="Insta" src="https://plixlifefc-media.farziengineer.co/hosted/original_insta_icon-2dd8fa98f9ce.png?auto=format&amp;fit=max&amp;w=64" decoding="async" data-nimg="intrinsic" className="social_media_icon" />
                                    </span>
                                </a>
                            </div>
                        </div>
                ...
                <div className="signup_button"><a href="/page/login">Sign up</a></div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" width="38" height="24" fill="none" data-src="/images/p1.svg">
                            ...
                            <defs>
                                <pattern id="pattern0-101" patternContentUnits="objectBoundingBox" width="1" height="1">
                                    <use xlinkHref="#image0_128:4220" transform="scale(.02632 .04167)"></use>
                                </pattern>
