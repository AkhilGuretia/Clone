          ...
          <li className="plixlife-main-menu__searchInput">
            <div className="input">
              <span className="input__icon-left">
                ...
                >
                  <path
                    d="M17.7188 17.5261L13.0078 12.8152C14.0273 11.5847 14.5898 10.0027 14.5898 8.28003C14.5898 4.27222 11.2852 0.967529 7.27734 0.967529C3.23438 0.967529 0 4.27222 0 8.28003C0 12.323 3.26953 15.5925 7.27734 15.5925C8.96484 15.5925 10.5469 15.03 11.8125 14.0105L16.5234 18.7214C16.6992 18.8972 16.9102 18.9675 17.1562 18.9675C17.3672 18.9675 17.5781 18.8972 17.7188 18.7214C18.0703 18.405 18.0703 17.8777 17.7188 17.5261ZM1.6875 8.28003C1.6875 5.18628 4.18359 2.65503 7.3125 2.65503C10.4062 2.65503 12.9375 5.18628 12.9375 8.28003C12.9375 11.4089 10.4062 13.905 7.3125 13.905C4.18359 13.905 1.6875 11.4089 1.6875 8.28003Z"
                    fill="white"
                  ></path>
                </svg>
              </span>
            ...
            <div data-test="userButton" className="menu-dropdown">
              <span className="main-menu__icon main-menu__user--active">
                ...
                >
                  ...
                  ></path>
                  <path
                    d="M4.44885 19.1091C4.44885 19.1091 6.77073 16.1445 12.4999 16.1445C18.2291 16.1445 20.552 19.1091 20.552 19.1091"
                    stroke="#FCFCEC"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  ...
                  <a href="/page/login">
                    <li data-test="desktopMenuMyAccountLink">
                      ...
                      >
                        <path
                          fill="#5DD37C"
                          d="M9.545.002c.48 0 .95.136 1.364.395.415.258.76.63.999 1.079.24.448.365.956.365 1.473 0 .518-.126 1.026-.366 1.474H15v1.473h-1.364v7.367a.768.768 0 01-.2.521.657.657 0 01-.482.216H2.045a.657.657 0 01-.482-.216.768.768 0 01-.2-.52V5.895H0V4.422l3.093.001a3.153 3.153 0 01-.306-2.095A2.974 2.974 0 013.862.554 2.577 2.577 0 015.76.019 2.669 2.669 0 017.5 1c.255-.314.57-.566.922-.738.353-.172.735-.26 1.122-.26zM8.182 5.896H6.818v7.367h1.364V5.896zm-2.727-4.42c-.353 0-.691.149-.944.413a1.53 1.53 0 00-.416 1.005c-.013.38.11.751.345 1.035.234.284.561.46.912.489l.103.004h1.363V2.95c0-.352-.116-.693-.329-.96a1.34 1.34 0 00-.828-.497l-.105-.013-.102-.004zm4.09 0c-.344 0-.675.14-.927.393-.252.252-.407.599-.433.97l-.003.11v1.473h1.363c.344 0 .676-.14.928-.393s.406-.599.432-.97l.004-.11c0-.39-.144-.766-.4-1.042a1.314 1.314 0 00-.964-.432z"
                        ></path>
                      </svg>
                      Order history
                    </li>
        ...
        <ul className="plixlife-main-menu-sub__lower__desktop__nav-row">
          <li data-test="mainMenuItem" className="plixlife-main-menu__item">
            <ul className="plixlife-main-menu__nav-dropdown plixlife-main-menu__nav-dropdown__remainingNav">
              <li>
                <a href="/page/plix-flashsale">🤑 Sale</a>
              </li>
          ...
          <li data-test="mainMenuItem" className="plixlife-main-menu__item">
            <ul className="plixlife-main-menu__nav-dropdown plixlife-main-menu__nav-dropdown__remainingNav">
              <li>
                <a href="/page/membership"> 🌱 Loyalty Membership</a>
              </li>
              <li className="plixlife-main-menu__nav-dropdown__body plixlife-main-menu__nav-dropdown__remainingLinks"></li>
            </ul>
          </li>
          ...
          <li data-test="mainMenuItem" className="plixlife-main-menu__item">
            <ul className="plixlife-main-menu__nav-dropdown plixlife-main-menu__nav-dropdown__remainingNav">
              <li>
                <a href="/page/build-your-box-5"> 🎁Build Your Own Box</a>
              </li>
              <li className="plixlife-main-menu__nav-dropdown__body plixlife-main-menu__nav-dropdown__remainingLinks">
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__heading heading">
                    <a href="https://www.plixlife.com/page/build-your-box-5">
                      Box of 5 at ₹ 1400
                    </a>
                  </div>
                  <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__ul"></ul>
          ...
          <li data-test="mainMenuItem" className="plixlife-main-menu__item">
            <ul className="plixlife-main-menu__nav-dropdown plixlife-main-menu__nav-dropdown__remainingNav">
              ...
              <li className="plixlife-main-menu__nav-dropdown__body plixlife-main-menu__nav-dropdown__remainingLinks">
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__heading heading">
                    <a href="/collection/dull-skin/208">
                      {" "}
                      Dry &amp; Dull Skin{" "}
                    </a>
                  </div>
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__heading heading">
                    <a href="https://www.plixlife.com/collection/pigmentation-and-dark-spots/209">
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__heading heading">
                    <a href="https://www.plixlife.com/collection/dark-circles/210">
                      Dark Circles
                    </a>
                  </div>
                  <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__ul"></ul>
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__heading heading">
                    <a href="https://www.plixlife.com/collection/acne/207">
                      Acne Care
                    </a>
                  </div>
                  <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__ul"></ul>
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__heading heading">
                    <a href="https://www.plixlife.com/collection/anti-aging/235">
                      Anti Ageing
                    </a>
                  </div>
                  <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__new__list__ul"></ul>
                ...
                <div className="plixlife-main-menu__nav-dropdown__body__mainContainer">
                  <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks">
                    <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list">
                      <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__heading heading">
                        Nutrition
                      </div>
                      <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul">
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/weight-management/134">
                            🍎Weight Loss
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/skin-and-hair/228">
                            🙆🏻‍♀️Skin &amp; Hair Nutrition
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/sexual-wellness/136">
                            🍑Sexual Wellness
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/proteins/227">
                            🌱Plant Proteins
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/daily-wellbeing/73">
                            💊Daily Wellness
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list">
                      ...
                      <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul">
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/facewash/215">
                            ✨Facewash
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/skin-care-serum/213">
                            😍 Face Serum
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/moisturizers/217">
                            💧Face Moisturizer
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/sunscreen/218">
                            ☀️Suncreen
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/lip-care/219">
                            💋Dry &amp; Dark Lips
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/undereye/220">
                            👁️Under Eye Care
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/skin-care/75">
                            💯All
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list">
                      ...
                      <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul">
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/intimate-lightening/224">
                            🍑Intimate lightening
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/bodycare/222">
                            💯All
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list">
                      ...
                      <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul">
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/hair-serum/221">
                            😍Hair Serum
                          </a>
                        </li>
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/hair/76">
                            💯All
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list">
                      ...
                      <ul className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul">
                        <li className="plixlife-main-menu__nav-dropdown__body__mainContainer__remainingNavLinks__list__ul__li list-item">
                          <a href="https://www.plixlife.com/collection/accessories/225">
                            💯All
                          </a>
                        </li>
                      </ul>
                          ...
                          <span className="plixlife-main-menu__nav-dropdown__body__withImagesContainer__imageDiv_span1">
                            <span className="plixlife-main-menu__nav-dropdown__body__withImagesContainer__imageDiv_span1">
                              <img
                                alt=""
                                aria-hidden="true"
                                src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27280%27%20height=%27240%27/%3e"
                                style={{
                                  background: "none",
                                  maxWidth: 100 + "%",
                                  opacity: 1,
                            ...
                            <img
                              alt="Skin"
                              src="https://images.plixlife.com/hosted/Mobile_search_banner-_Skin-1-dd417b21b5de.jpg?auto=format&amp;fit=max&amp;w=768"
                              decoding="async"
                              data-nimg="intrinsic"
                              style={{
                                position: "absolute",
                          ...
                          <div>
                            <a href="/collection/skin-care/75">
                              ...
                              >
                                ...
                                <path
                                  fill="#FEFFED"
                                  d="M13.195 7.796l4.297 4.102a.611.611 0 01.195.439.602.602 0 01-.195.415l-4.297 4.101c-.22.22-.61.22-.83-.024a.583.583 0 01.025-.83l3.247-3.076H7.336a.578.578 0 01-.586-.586c0-.342.244-.586.586-.586h8.3l-3.246-3.1a.583.583 0 01-.025-.83c.22-.245.586-.245.83-.025z"
                                ></path>
                              </svg>
                            </a>
                          </div>
                      ...
                      <div className="plixlife-main-menu__nav-dropdown__body__withImagesContainer__imageDiv">
                        <a href="/collection/weight-management/134">
                          <span>
                            ...
                            <img
                              alt="Weight Loss"
                              src="https://images.plixlife.com/hosted/Mobile_search_banner-_weight-1-866fb59514ad.jpg?auto=format&amp;fit=max&amp;w=768"
                              decoding="async"
                              data-nimg="intrinsic"
                            />
                          </span>
          ...
          <li data-test="mainMenuItem" className="plixlife-main-menu__item">
            <ul className="plixlife-main-menu__nav-dropdown plixlife-main-menu__nav-dropdown__remainingNav">
              <li>
                <a href="/collection/all-products/91">💯All Products </a>
              </li>
              <li className="plixlife-main-menu__nav-dropdown__body plixlife-main-menu__nav-dropdown__remainingLinks"></li>
            </ul>
          </li>
